...
public class ThirdFragment extends Fragment {
    ...
    private int cloudCoverGreen;
    private int precipitationBlue;
    private int humidityRed;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            cloudCoverGreen = currentDayData.getInt("cloudCover");
            precipitationBlue = currentDayData.getInt("precipitationProbability");
            humidityRed = (int) currentDayData.getDouble("humidity");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        HIChartView chartView = getView().findViewById(R.id.chart2);
...
//        plotOptions.getSolidgauge().getDataLabels().setEnabled(false);
        ...
        data1.setColor(HIColor.initWithRGBA(102, 204, 0, 255));
        data1.setRadius("112%");
        data1.setInnerRadius("88%");
        data1.setY(cloudCoverGreen);
        ...
        data2.setColor(HIColor.initWithRGBA(102,178,255,255));
        data2.setRadius("87%");
        data2.setInnerRadius("63%");
        data2.setY(precipitationBlue);
        ...
        data3.setColor(HIColor.initWithRGBA(255,102,102,255));
        data3.setRadius("62%");
        data3.setInnerRadius("38%");
        data3.setY(humidityRed);
